// See https://github.com/bluealloy/revm/blob/main/crates/revm/src/instructions/i256.rs
...
fn u256_remove_sign(val: &mut U256) {
    unsafe {
        *val.0.get_unchecked_mut(3) =
            val.0.get_unchecked(3) & FLIPH_BITMASK_U64;
    }
}
